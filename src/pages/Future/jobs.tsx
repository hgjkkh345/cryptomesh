    ...
    desc: `<div class="job__description body">
      ...
      <div><p><strong>RESPONSIBILITIES:</strong></p>
        <ul>
          ...
          <li>Develop open source blockchain-based code that powers the Cryptomesh.io protocol</li>
    ...
    desc: `<div class="job__description body">
      ...
      <div><p><strong>RESPONSIBILITIES:</strong></p>
        <ul>
          ...
          <li style={{fontWeight: 400}}><span style={{fontWeight: 400}}>Develop open source blockchain-based code that powers the Cryptomesh.io protocol.</span>
          </li>
