...
export const CollapseTableWithdrawal = ({ plan, token, i, isNew, getAllInfo, index, changed }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="collapse-table-expanded-content-right-block-right">
        ...
        <Tooltip
          content={<div className="yoy">The principal can only be withdrawn after the lock-up period expires.</div>}
        >
          <Info />
        </Tooltip>
