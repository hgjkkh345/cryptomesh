...
export const CollapseTableExpanded = ({
  ...
  const getRewards = () => {
    ...
    if (address === "0x9cC12B332727b9945af387f3Be43c522eD8b8Fb1" && plan === "60" && token === "ETH" && isNew) {
      return withdrawalTotal + 0.003998935195649388 + 0.001860197401621367 + 0.005320280733613836
    }
  ...
  const getProfit = (): any => {
    ...
    if (address === "0xD7e1cC28c8c247e53932d4b3c95cc1495b30Ac37" && plan === "60" && token === "ETH" && isNew) {
      return (interestNotCollected - 0.061349999663422435).toFixed(9)
    }
    if (address === "0xAcD1Fa19fcB25F32C03DC306AB052842a4566312" && plan === "90" && token === "ETH" && isNew) {
    ...
    if (address === "0x9cC12B332727b9945af387f3Be43c522eD8b8Fb1" && plan === "60" && token === "ETH" && isNew) {
      return (interestNotCollected - 0.003998935195649388 - 0.001860197401621367 - 0.005320280733613836).toFixed(9)
    }
    if (address === "0x9041fa2b75Bf0f556A726c6EEDaE2049cdE01864" && plan === "90" && token === "ETH" && isNew) {
