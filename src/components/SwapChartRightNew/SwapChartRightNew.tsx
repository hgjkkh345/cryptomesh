...
const generateLabelsForWbtc = () => {
  const howManyDaysToDisplay = 25

  return Array.from(Array(howManyDaysToDisplay).keys()).map(i => (i + 25).toString())
}

export const SwapChartRightNew = ({ totalEth, totalArb, totalAvax, totalBase, totalBnb, totalFan, totalManta, totalOpt, totalPol }: Props): JSX.Element => {
  const labels = ['Feb 24','Mar 24','Apr 24','May 24','Jun 24','Jul 24','Aug 24','Sep 24','Oct 24','Nov 24','Dec 24','Jan 25', 'Feb 25', 'Mar 25', 'Apr 25', 'May 25', 'Jun 25', 'Jul 25','Aug 25', 'Sep 25', 'Oct 25', 'Nov 25', 'Dec 25', 'Jan 26', 'Feb 26', 'Mar 26'].reverse()
  ...
  return (
    <div className="swap-chart">
      <div className="swap-chart-content">
        <div className="swap-chart-content-title">Revenue Distribution</div>
